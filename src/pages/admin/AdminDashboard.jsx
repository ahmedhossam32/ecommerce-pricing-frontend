...
function AdminDashboard() {
  ...
  const statCards = stats ? [
    ...
    { label: 'Live Products',      value: stats.liveProducts,           icon: FiCheckCircle, color: 'text-green-500',   bg: 'bg-green-50',     hero: false, hoverBorder: 'hover:border-green-300',    hoverShadow: 'hover:shadow-green-100',    navigateTo: '/admin/products'  },
    ...
    { label: 'Rejected Products',  value: stats.rejectedProducts,       icon: FiXCircle,     color: 'text-red-400',     bg: 'bg-red-50',       hero: false, hoverBorder: 'hover:border-red-300',      hoverShadow: 'hover:shadow-red-100',      navigateTo: '/admin/products'  },
